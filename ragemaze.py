...
ketchy = goal(1, 3, (255, 29, 10))#making our goal if we used the og surface those three numbers is our rgb 
...
while running: #this is saying that while True, which is an infinant loop 
    ...
    if not Weenie.movement_disabled:
        ...
        sensitivity = .1 #variable used to desenitize our movement
